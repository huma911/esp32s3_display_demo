...
static void screen_main_event_handler (lv_event_t *e)
{
    ...
    {
        ui_load_scr_animation(&guider_ui, &guider_ui.screen_aclock, guider_ui.screen_aclock_del, &guider_ui.screen_main_del, setup_scr_screen_aclock, LV_SCR_LOAD_ANIM_NONE, 0, 0, false, false);
        break;
    }
    default:
        break;
...
static void screen_aclock_event_handler (lv_event_t *e)
{
    lv_event_code_t code = lv_event_get_code(e);
    switch (code) {
    case LV_EVENT_CLICKED:
